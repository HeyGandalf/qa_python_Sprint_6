...
class BasePageLocator:
    ...
    YANDEX_SITE_BUTTON = (By.CSS_SELECTOR, "a[href*='yandex.ru']")
    SCOOTER_SITE_BUTTON = [By.XPATH, ".//img[@alt='Scooter']/parent::a"]
...
class ScooterOrderPageLocator:
    ...
    INCORRECT_SUBWAY_MESSAGE = [By.XPATH,
                                ".//input[contains(@placeholder,'метро')]/parent::div/parent::div/parent::div/div["
                                "@class!='select-search']"]

    @staticmethod
    def subway_hint_button(subway_station: str):
        return [By.XPATH, f".//div[text()='{subway_station}']/parent::button"]

    PHONE_NUMBER_FIELD = [By.XPATH, ".//input[contains(@placeholder,'Телефон')]"]
    INCORRECT_PHONE_NUMBER_MESSAGE = [By.XPATH, ".//input[contains(@placeholder,'Телефон')]/parent::div/div"]
